!function (t) {
    ...
    var v = function () {
        ...
        return e = t, r = [{
            ...
            key: "includes", value: function () {
                ...
                var l = this.sri, c = this.sci, s = this.eri, u = this.eci;
            ...
            key: "difference", value: function (e) {
                var n = [], r = function (e, r, i, o) {
                    ...
                    }, i = this.sri, o = this.sci, a = this.eri, l = this.eci, c = e.sri - i, s = e.sci - o, u = a - e.eri,
                    f = l - e.eci;
        ...
        return e = t, (n = [{
            ...
            key: "shift", value: function (t, e, n, r) {
                this._.forEach(function (i) {
                    var o = i.sri, a = i.sci, l = i.eri, c = i.eci, s = i;
    ...
    function D(t, e, n) {
        ...
        var r = I(e), i = I(n), o = Number(e), a = Number(n), l = 0;
    ...
    var N = function () {
        ...
        return e = t, (n = [{
            ...
            key: "unhide", value: function (t) {
                for (var e = t; e > 0 && (e -= 1, this.isHide(e));) this.setHide(e, !1)
            }
        }, {
            key: "isHide", value: function (t) {
                var e = this.get(t);
                return e && e.hide
            }
        }, {
            key: "setHide", value: function (t, e) {
            ...
            key: "copyPaste", value: function (t, e, n) {
                var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
                    ...
                    }, o = t.sri, a = t.sci, l = t.eri, c = t.eci, s = e.sri, u = e.sci, f = e.eri, h = e.eci,
                    d = t.size(), y = H(d, 2), v = y[0], b = y[1], g = e.size(), m = H(g, 2), w = m[0], k = m[1],
                    O = !0, S = 0;
                (f < o || h < a) && (O = !1, S = f < o ? w : k);
                for (var x = o; x <= l; x += 1) if (this._[x]) for (var E = a; E <= c; E += 1) if (this._[x].cells && this._[x].cells[E]) for (var j = s; j <= f; j += v) for (var _ = u; _ <= h; _ += b) {
                    var C = j + (x - o), T = _ + (E - a), P = z.cloneDeep(this._[x].cells[E]);
                    r && P && P.text && P.text.length > 0 && function () {
                        var t = P.text, e = _ - u + (j - s) + 2;
            ...
            key: "maxCell", value: function () {
                var t = Object.keys(this._), e = t[t.length - 1], n = this._[e];
                if (n) {
    ...
    var W = function () {
        ...
        en: {
            ...
            print: {size: "Paper size", orientation: "Page orientation", orientations: ["Landscape", "Portrait"]},
            format: {
                normal: "Normal",
                text: "Plain Text",
                number: "Number",
            ...
            button: {next: "Next", cancel: "Cancel", remove: "Remove", save: "Save", ok: "OK"},
    ...
    function B(t, e) {
        if (e && e[V]) for (var n = e[V], r = t.split("."), i = 0; i < r.length; i += 1) {
            var o = n[r[i]];
    ...
    var K = {phone: /^[1-9]\d{10}$/, email: /w+([-+.]w+)*@w+([-.]w+)*.w+([-.]w+)*/};
    ...
    var nt = function () {
        ...
        return et(t, [{
            ...
            key: "validate", value: function (t, e, n) {
                ...
                if (null !== r) {
                    var a = G(r.validator.validate(n), 2), l = a[0], c = a[1];
            ...
            key: "add", value: function (t, e, n) {
                var r = n.type, i = n.required, o = n.value, a = n.operator, l = new Z(r, i, o, a),
    ...
    function ct(t, e) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function () {
            }, r = this.merges, i = e.clone(), o = at(t.size(), 2), a = o[0], l = o[1], c = at(e.size(), 2), s = c[0],
            u = c[1];
    ...
    function st(t, e, n) {
        ...
        "all" !== n && "format" !== n || (i.deleteCells(e, n), o.deleteWithin(e)), i.copyPaste(t, e, n, r, function (t, e, n) {
            if (n && n.merge) {
                var r = at(n.merge, 2), i = r[0], a = r[1];
                if (i <= 0 && a <= 0) return;
    ...
    function ft(t, e, n) {
        ...
        void 0 !== i.style && (o = z.cloneDeep(r[i.style])), o = z.merge(o, {border: n}), i.style = this.addStyle(o)
    }
    ...
    var ht = function () {
        ...
        return e = t, (n = [{
            ...
            key: "pasteFromText", value: function (t) {
                var e = t.split("\r\n").map(function (t) {
                    return t.replace(/"/g, "").split("\t")
                });
                e.length > 0 && (e.length -= 1);
                var n = this.rows, r = this.selector;
                this.changeData(function () {
                    n.paste(e, r.range)
                })
            }
            ...
            key: "calSelectedRangeByEnd", value: function (t, e) {
                var n = this.selector, r = this.rows, i = this.cols, o = this.merges, a = n.range, l = a.sri, c = a.sci,
                    s = a.eri, u = a.eci, f = n.ri, h = n.ci, p = t, d = e;
                ...
                this.changeData(function () {
                    ...
                    if ("merge" === t) e ? n.merge() : n.unmerge(); else if ("border" === t) (function (t) {
                        var e = this, n = t.mode, r = t.style, i = t.color, o = this.styles, a = this.selector,
                            l = this.rows, c = a.range, s = c.sri, u = c.sci, f = c.eri, h = c.eci,
                            p = !this.isSignleSelected();
                        if (p || "inside" !== n && "horizontal" !== n && "vertical" !== n) if ("outside" !== n || p) {
                            if ("none" === n) a.range.each(function (t, n) {
                                ...
                                for (var t = [], o = s; o <= f; o += 1) for (var a = u; a <= h; a += 1) {
                                    for (var c = [], d = 0; d < t.length; d += 1) {
                                        var y = at(t[d], 4), v = y[0], b = y[1], g = y[2], m = y[3];
                        ...
                        if (void 0 !== l.style && (c = z.cloneDeep(i[l.style])), "format" === t) c.format = e, l.style = n.addStyle(c); else if ("font-bold" === t || "font-italic" === t || "font-name" === t || "font-size" === t) {
                            var s = {};
            ...
            key: "setSelectedCellText", value: function (t) {
                ...
                var c = i.getCell(l, a), s = c ? c.text : "";
            ...
            key: "getRect", value: function (t) {
                ...
                var s = r.sumWidth(0, a), u = n.sumHeight(0, o, i), f = n.sumHeight(o, l + 1, i),
                    h = r.sumWidth(a, c + 1), p = s - e.x, d = u - e.y, y = this.freezeTotalHeight(),
            ...
            key: "getCellRectByXY", value: function (t, e) {
                ...
                }.call(this, e, n.y), l = a.ri, c = a.top, s = a.height, u = function (t, e) {
                ...
                }.call(this, t, n.x), f = u.ci, h = u.left, p = u.width;
            ...
            key: "isSignleSelected", value: function () {
                ...
                if (o && o.merge) {
                    var a = at(o.merge, 2), l = a[0], c = a[1];
            ...
            key: "insert", value: function (t) {
                var e = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1;
                this.changeData(function () {
                    var r = e.selector.range, i = r.sri, o = r.sci, a = e.rows, l = e.merges, c = e.cols, s = i;
            ...
            key: "delete", value: function (t) {
                ...
                this.changeData(function () {
                    var n = e.rows, r = e.merges, i = e.selector, o = e.cols, a = i.range, l = i.range, c = l.sri,
                        s = l.sci, u = l.eri, f = l.eci, h = at(i.range.size(), 2), p = h[0], d = h[1], y = c, v = p;
            ...
            key: "scrollx", value: function (t, e) {
                var n = this.scroll, r = this.freeze, i = this.cols, o = at(r, 2)[1],
                    a = at(z.rangeReduceIf(o, i.len, 0, 0, t, function (t) {
                        return i.getWidth(t)
                    }), 3), l = a[0], c = a[1], s = a[2], u = c;
                t > 0 && (u += s), n.x !== u && (n.ci = t > 0 ? l : 0, n.x = u, e())
            }
        }, {
            key: "scrolly", value: function (t, e) {
                var n = this.scroll, r = this.freeze, i = this.rows, o = at(r, 1)[0],
                    a = at(z.rangeReduceIf(o, i.len, 0, 0, t, function (t) {
            ...
            key: "cellRect", value: function (t, e) {
                ...
                if (null !== a && a.merge) {
                    var s = at(a.merge, 2), u = s[0], f = s[1];
                    if (u > 0) for (var h = 1; h <= u; h += 1) c += n.getHeight(t + h);
                    if (f > 0) for (var p = 1; p <= f; p += 1) l += r.getWidth(e + p)
                }
            ...
            key: "freezeIsActive", value: function () {
                var t = at(this.freeze, 2), e = t[0], n = t[1];
                return e > 0 || n > 0
            }
        }, {
            ...
            key: "contentRange", value: function () {
                var t = this.rows, e = this.cols, n = at(t.maxCell(), 2), r = n[0], i = n[1], o = t.sumHeight(0, r + 1),
                    a = e.sumWidth(0, i + 1);
            ...
            key: "hideRowsOrCols", value: function () {
                var t = this.rows, e = this.cols, n = this.selector, r = at(n.size(), 2), i = r[0], o = r[1],
                    a = n.range, l = a.sri, c = a.sci, s = a.eri, u = a.eci;
                if (i === t.len) for (var f = c; f <= u; f += 1) e.setHide(f, !0); else if (o === e.len) for (var h = l; h <= s; h += 1) t.setHide(h, !0)
            }
        }, {
            key: "unhideRowsOrCols", value: function (t, e) {
            ...
            key: "rowEach", value: function (t, e, n) {
                ...
                for (var s = t + l; s <= e + l; s += 1) if (o.has(s)) l += 1; else {
                    var u = i.getHeight(s);
    ...
    var kt = function () {
        ...
        var e, n, r;
        return e = t, (n = [{
            key: "showUnhide", value: function (t) {
                this.unhideIndex = t, this.unhideHoverEl.show()
            }
        }, {
            key: "hideUnhide", value: function () {
            ...
            key: "show", value: function (t, e) {
                ...
                if (!n) {
                    ...
                    a.offset({left: r ? c + u - 5 : c, top: r ? s : s + f - 5}).show(), i.offset({
                        width: r ? 5 : u,
                        height: r ? f : 5
                    }), o.offset({width: r ? 0 : e.width, height: r ? e.height : 0}), l.offset({
                        left: r ? 5 - u : c,
                        top: r ? s : 5 - f,
                        width: r ? 5 : u,
                        height: r ? f : 5
            ...
            key: "mousedblclickHandler", value: function () {
    ...
    var St = function () {
        function t(e) {
            ...
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, t), this.vertical = e, this.moveFn = null, this.el = a("div", "".concat(mt, "-scrollbar ").concat(e ? "vertical" : "horizontal")).child(this.contentEl = a("div", "")).on("mousemove.stop", function () {
    ...
    var _t = 10, Ct = function () {
        function t() {
            var e = this, n = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
            xt(this, t), this.useHideInput = n, this.inputChange = function () {
            }, this.cornerEl = a("div", "".concat(mt, "-selector-corner")), this.areaEl = a("div", "".concat(mt, "-selector-area")).child(this.cornerEl).hide(), this.clipboardEl = a("div", "".concat(mt, "-selector-clipboard")).hide(), this.autofillEl = a("div", "".concat(mt, "-selector-autofill")).hide(), this.el = a("div", "".concat(mt, "-selector")).css("z-index", "".concat(_t)).children(this.areaEl, this.clipboardEl, this.autofillEl).hide(), n && (this.hideInput = a("input", "").on("compositionend", function (t) {
        ...
        return jt(t, [{
            ...
            key: "setAreaOffset", value: function (t) {
                var e = t.left, n = t.top,
                    r = {width: t.width - 3 + .8, height: t.height - 3 + .8, left: e - .8, top: n - .8};
    ...
    function Tt(t) {
        var e = this.data, n = t.left, r = t.top, i = t.width, o = t.height, a = t.scroll, l = t.l, c = t.t,
            s = e.freezeTotalWidth(), u = e.freezeTotalHeight(), f = n - s;
        s > l && (f -= a.x);
        var h = r - u;
    ...
    var Wt = function () {
        function t(e) {
            var n = this;
            xt(this, t), this.inputChange = function () {
            }, this.data = e, this.br = new Ct(!0), this.t = new Ct, this.l = new Ct, this.tl = new Ct, this.br.inputChange = function (t) {
                n.inputChange(t)
        ...
        return jt(t, [{
            key: "resetData", value: function (t) {
            ...
            key: "showAutofill", value: function (t, e) {
                if (-1 !== t || -1 !== e) {
                    var n = this.range, r = n.sri, i = n.sci, o = n.eri, a = n.eci, l = t, c = e, s = r - t, u = o - t,
                        f = a - e;
                    if (i - e > 0) this.arange = new v(r, c, o, i - 1); else if (s > 0) this.arange = new v(l, i, r - 1, a); else if (f < 0) this.arange = new v(r, a + 1, o, c); else {
                    ...
                    if (null !== this.arange) {
                        ...
                        var p = this.br, d = this.l, y = this.t, b = this.tl;
            ...
            key: "buildBody", value: function () {
                var t, e = this, n = this.value, r = this.cvalue, i = this.bodyEl, o = function (t, e, n) {
                    for (var r = new Date(t, e, 1, 23, 59, 59), i = [[], [], [], [], [], []], o = 0; o < 6; o += 1) for (var a = 0; a < 7; a += 1) {
                        var l = te(r, 7 * o + a), c = l.getMonth() !== e,
        ...
        if (!/^\s*$/.test(t)) {
            var e = this.textlineEl, n = this.textEl, r = this.areaOffset, i = t.split("\n"),
                o = Math.max.apply(Math, oe(i.map(function (t) {
                    return t.length
                }))), a = e.offset().width / t.length, l = (o + 1) * a + 5, c = this.viewFn().width - r.left - a,
                s = i.length;
            if (l > r.width) {
                var u = l;
    ...
    function le(t) {
        var e = t.keyCode, n = t.altKey;
        13 !== e && 9 !== e && t.stopPropagation(), 13 === e && n && (function (t, e) {
            var n = t.target, r = n.value, i = n.selectionEnd,
    ...
    var se = function () {
        function t(e, n, r) {
            ...
            !function (t, e) {
                ...
                return function (t) {
                    var e = t.target.value, n = this.suggest, r = this.textlineEl, i = this.validator, o = this.cell;
                    if (null !== o) if ("editable" in o && !0 === o.editable || void 0 === o.editable) {
            ...
            }), this.el = a("div", "".concat(mt, "-editor")).child(this.areaEl).hide(), this.suggest.bindInputEvents(this.textEl), this.areaOffset = null, this.freeze = {
                w: 0,
                h: 0
        ...
        return e = t, (n = [{
            ...
            key: "setOffset", value: function (t) {
                ...
                if (t) {
                    this.areaOffset = t;
                    var l = t.left, c = t.top, s = t.width, u = t.height, f = t.l, h = t.t, p = {left: 0, top: 0};
                    o.w > f && o.h > h || (o.w < f && o.h < h ? (p.left = o.w, p.top = o.h) : o.w > f ? p.top = o.h : o.h > h && (p.left = o.w)), a.offset(p), r.offset({
                        left: l - p.left - .8,
                        top: c - p.top - .8
                    }), n.offset({width: s - 9 + .8, height: u - 3 + .8});
                    var d = {left: 0};
    ...
    var xe = function () {
        ...
        return me(t, [{
            ...
            key: "texty", value: function (t, e) {
                var n = this.height, r = this.padding, i = this.y;
    ...
    var je = function () {
            ...
            return me(t, [{
                ...
                key: "text", value: function (t, e) {
                    var n = this, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                        i = !(arguments.length > 3 && void 0 !== arguments[3]) || arguments[3], o = this.ctx, a = r.align,
                        l = r.valign, c = r.font, s = r.color, u = r.strike, f = r.underline, h = e.textx(a);
                    ...
                    var v = (y.length - 1) * (c.size + 2), b = e.texty(l, v);
                ...
                key: "line", value: function () {
                    ...
                    if (arguments.length > 1) {
                        var e = arguments.length <= 0 ? void 0 : arguments[0], n = ve(e, 2), r = n[0], i = n[1];
                        t.moveTo(Se(r), Se(i));
                        for (var o = 1; o < arguments.length; o += 1) {
                            var a = o < 0 || arguments.length <= o ? void 0 : arguments[o], l = ve(a, 2), c = l[0],
                                s = l[1];
                            t.lineTo(Se(c), Se(s))
                        }
                        t.stroke()
        ...
        }(), _e = [{key: "Arial", title: "Arial"}, {key: "Helvetica", title: "Helvetica"}, {
            key: "Source Sans Pro",
        ...
        Ce = [{pt: 7.5, px: 10}, {pt: 8, px: 11}, {pt: 9, px: 12}, {pt: 10, px: 13}, {pt: 10.5, px: 14}, {
            pt: 11,
            px: 15
    ...
    var Pe = function (t) {
        for (var e = [], n = [], r = [], i = 0, o = "", a = 1, l = "", c = 0; c < t.length; c += 1) {
            var s = t.charAt(c);
            if (" " !== s) {
                if (s >= "a" && s <= "z") r.push(s.toUpperCase()); else if (s >= "0" && s <= "9" || s >= "A" && s <= "Z" || "." === s) r.push(s); else if ('"' === s) {
                    for (c += 1; '"' !== t.charAt(c);) r.push(t.charAt(c)), c += 1;
                    n.push('"'.concat(r.join(""))), r = []
                } else if ("-" === s && /[+\-*/,(]/.test(l)) r.push(s); else {
                    if ("(" !== s && r.length > 0 && n.push(r.join("")), ")" === s) {
                        var u = e.pop();
                        if (2 === i) try {
                            for (var p = Te(f(n.pop()), 2), d = p[0], y = p[1], v = Te(f(n.pop()), 2), b = v[0], g = v[1], m = 0, w = b; w <= d; w += 1) for (var k = g; k <= y; k += 1) n.push(h(w, k)), m += 1;
                            n.push([u, m])
                        } catch (t) {
                        ...
                        var O = t.charAt(c + 1);
                        o = s, "=" !== O && "-" !== O || (o += O, c += 1), i = 3
                    } else if (":" === s) i = 2; else if ("," === s) 3 === i && n.push(o), i = 1, a += 1; else if ("(" === s && r.length > 0) e.push(r.join("")); else {
                        if (e.length > 0 && ("+" === s || "-" === s)) {
                            var S = e[e.length - 1];
                            if ("(" !== S && n.push(e.pop()), "*" === S || "/" === S) for (; e.length > 0 && "(" !== (S = e[e.length - 1]);) n.push(e.pop())
                        }
                        e.push(s)
                    }
                    r = []
        ...
        for (var i = [], o = 0; o < t.length; o += 1) {
            ...
            if ("+" === a) {
                var c = i.pop();
                i.push(D("+", i.pop(), c))
            } else if ("-" === a) if (1 === i.length) {
                var s = i.pop();
                i.push(D("*", s, -1))
            } else {
                var u = i.pop();
                i.push(D("-", i.pop(), u))
            } else if ("*" === a) i.push(D("*", i.pop(), i.pop())); else if ("/" === a) {
                var f = i.pop();
                i.push(D("/", i.pop(), f))
            } else if ("=" === l || ">" === l || "<" === l) {
                var h = i.pop();
    ...
    var He = [{
        key: "SUM", title: U("formula.sum"), render: function (t) {
            return t.reduce(function (t, e) {
                return D("+", t, e)
            }, 0)
        }
    }, {
        key: "AVERAGE", title: U("formula.average"), render: function (t) {
            return t.reduce(function (t, e) {
                return Number(t) + Number(e)
            }, 0) / t.length
        }
    }, {
        key: "MAX", title: U("formula.max"), render: function (t) {
            return Math.max.apply(Math, ze(t.map(function (t) {
                return Number(t)
            })))
        }
    }, {
        key: "MIN", title: U("formula.min"), render: function (t) {
            return Math.min.apply(Math, ze(t.map(function (t) {
                return Number(t)
            })))
        }
    }, {
        key: "IF", title: U("formula._if"), render: function (t) {
            var e = De(t, 3), n = e[0], r = e[1], i = e[2];
            return n ? r : i
        }
    }, {
        key: "AND", title: U("formula.and"), render: function (t) {
            return t.every(function (t) {
                return t
            })
        }
    }, {
        key: "OR", title: U("formula.or"), render: function (t) {
            return t.some(function (t) {
                return t
            })
        }
    }, {
        key: "CONCAT", title: U("formula.concat"), render: function (t) {
            return t.join("")
        }
    }], Me = He, Ne = {};
    ...
    var qe = function (t) {
        ...
        if (/^(-?\d*.?\d*)$/.test(t)) {
            var e = We(Number(t).toFixed(2).toString().split("\\.")), n = e[0], r = e.slice(1);
            return [n.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,")].concat(Fe(r))
        }
        return t
    }, Le = [{key: "normal", title: U("format.normal"), type: "string", render: qe}, {
        key: "text",
        title: U("format.text"),
        type: "string",
        render: qe
    }, {key: "number", title: U("format.number"), type: "number", label: "1,000.12", render: Be}, {
        key: "percent",
        ...
        key: "rmb", title: U("format.rmb"), type: "number", label: "￥10.00", render: function (t) {
            return "￥".concat(Be(t))
        }
    }, {
        key: "usd", title: U("format.usd"), type: "number", label: "$10.00", render: function (t) {
            return "$".concat(Be(t))
        }
    }, {
        key: "eur", title: U("format.eur"), type: "number", label: "€10.00", render: function (t) {
            return "€".concat(Be(t))
        }
    }, {key: "date", title: U("format.date"), type: "date", label: "26/09/2008", render: qe}, {
        key: "time",
        title: U("format.time"),
        type: "date",
        label: "15:59:00",
        ...
        render: qe
    }, {key: "duration", title: U("format.duration"), type: "date", label: "24:01:00", render: qe}], Ue = {};
    ...
    var Xe = 5, Ke = {fillStyle: "#f4f5f8"}, Je = {fillStyle: "#fff", lineWidth: ke, strokeStyle: "#e6e6e6"};

    function Ze(t, e, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0, i = t.cellRect(e, n), o = i.left,
            a = i.top, l = i.width, c = i.height;
        return new xe(o, a + r, l, c, Xe)
    }

    function Ge(t, e, n, r) {
        var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, o = e.sortedRowMap, a = e.rows,
            l = e.cols;
        if (!a.isHide(n) && !l.isHide(r)) {
            ...
            if (null !== s) {
                ...
                var f = e.getCellStyleOrDefault(c, r), h = Ze(e, n, r, i);
    ...
    function Qe(t, e, n, r, i) {
        var o = this.draw, a = this.data;
        o.save(), o.translate(e, n).translate(r, i);
        var l = a.exceptRowSet, c = a.exceptRowTotalHeight(t.sri, t.eri);
    ...
    function en(t, e, n, r, i, o) {
        var a = this, l = this.draw, c = this.data, u = e.h, f = e.w, h = o + r, p = i + n;
        l.save(), l.attr(Ke), "all" !== t && "left" !== t || l.fillRect(0, h, n, u), "all" !== t && "top" !== t || l.fillRect(p, 0, f, r);
        var d = c.selector.range, y = d.sri, v = d.sci, b = d.eri, g = d.eci;
        l.attr({
            textAlign: "center",
            textBaseline: "middle",
            ...
            var i = h + e, o = t;
            l.line([0, i], [n, i]), y <= o && o < b + 1 && tn.call(a, 0, i, n, r), l.fillText(o + 1, n / 2, i + r / 2), t > 0 && c.rows.isHide(t - 1) && (l.save(), l.attr({strokeStyle: "#c6c6c6"}), l.line([5, i + 5], [n - 5, i + 5]), l.restore())
        }), l.line([0, u + h], [n, u + h]), l.line([n, h], [n, u + h])), "all" !== t && "top" !== t || (c.colEach(e.sci, e.eci, function (t, e, n) {
            var i = p + e, o = t;
            l.line([i, 0], [i, r]), v <= o && o < g + 1 && tn.call(a, i, 0, n, r), l.fillText(s(o), i + n / 2, r / 2), t > 0 && c.cols.isHide(t - 1) && (l.save(), l.attr({strokeStyle: "#c6c6c6"}), l.line([i + 5, 5], [i + 5, r - 5]), l.restore())
        }), l.line([f + p, 0], [f + p, r]), l.line([0, r], [f + p, r])), l.restore()
    }

    function nn(t, e, n, r, i) {
        var o = t.sri, a = t.sci, l = t.eri, c = t.eci, s = t.w, u = t.h, f = this.draw, h = this.data, p = h.settings;
        ...
        return e = t, (n = [{
            ...
            key: "render", value: function () {
                ...
                var i = t.viewRange(), o = t.freezeTotalWidth(), a = t.freezeTotalHeight(), l = t.scroll, c = l.x,
                    s = l.y;
                nn.call(this, i, n, r, o, a), Qe.call(this, i, n, r, -c, -s), en.call(this, "all", i, n, r, o, a), function (t, e) {
                    var n = this.draw;
                    n.save(), n.attr({fillStyle: "#f4f5f8"}).fillRect(0, 0, t, e), n.restore()
                }.call(this, n, r);
                var u = Ye(t.freeze, 2), f = u[0], h = u[1];
                if (f > 0 || h > 0) {
                    if (f > 0) {
                        var p = i.clone();
                    ...
                    nn.call(this, y, n, r, 0, 0), en.call(this, "all", y, n, r, 0, 0), Qe.call(this, y, n, r, 0, 0), function (t, e, n, r) {
    ...
    var ln = [["A3", 11.69, 16.54], ["A4", 8.27, 11.69], ["A5", 5.83, 8.27], ["B4", 9.84, 13.9], ["B5", 6.93, 9.84]],
    ...
    var fn = function () {
        function t(e) {
            ...
            !function (t, e) {
                ...
                w: sn(ln[0][1]), h: sn(ln[0][2]), padding: 50, orientation: cn[0], get width() {
                ...
                var e = this.paper, n = t.target.value, r = ln[n];
                ...
                var e = this.paper, n = t.target.value, r = cn[n];
        ...
        return e = t, (n = [{
            ...
            key: "preview", value: function () {
                var t = this, e = this.data, n = this.paper, r = n.width, i = n.height, o = n.padding, l = r - 2 * o,
                    c = i - 2 * o, s = e.contentRange(), u = parseInt(s.h / c, 10) + 1, f = l / s.w, h = o, p = o;
                f > 1 && (h += (l - s.w) / 2);
                var d = 0, y = 0;
                this.contentEl.html(""), this.canvases = [];
                for (var v = {sri: 0, sci: 0, eri: 0, eci: 0}, b = function (n) {
                    var o = 0, l = 0,
            ...
            key: "toPrint", value: function () {
                this.el.hide();
                var t = this.paper, e = a("iframe", "").hide().el;
                window.document.body.appendChild(e);
                var n = e.contentWindow, r = n.document, i = document.createElement("style");
    ...
    var dn = [{key: "copy", title: U("contextmenu.copy"), label: "Ctrl+C"}, {
        key: "cut",
        ...
        label: "Ctrl+Alt+V"
    }, {key: "divider"}, {key: "insert-row", title: U("contextmenu.insertRow")}, {
        key: "insert-column",
        title: U("contextmenu.insertColumn")
    }, {key: "divider"}, {key: "delete-row", title: U("contextmenu.deleteRow")}, {
        key: "delete-column",
    ...
    }, {key: "divider"}, {key: "cell-printable", title: U("contextmenu.cellprintable")}, {
        key: "cell-non-printable",
        title: U("contextmenu.cellnonprintable")
    }, {key: "divider"}, {key: "cell-editable", title: U("contextmenu.celleditable")}, {
    ...
    var vn = function () {
        function t(e) {
            ...
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, t), this.menuItems = yn.call(this), this.el = (n = a("div", "".concat(mt, "-contextmenu"))).children.apply(n, hn(this.menuItems)).hide(), this.viewFn = e, this.itemClick = function () {
            }, this.isHide = r, this.setMode("range")
        }
    ...
    var An = function (t) {
        function e(t, n, r, i) {
            ...
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
            }(this, e), (l = Cn(this, Tn(e).call(this, "div", "".concat(mt, "-dropdown ").concat(i)))).title = t, l.change = function () {
            }, l.headerClick = function () {
            }, "string" == typeof t ? l.title = a("div", "".concat(mt, "-dropdown-title")).child(t) : r && l.title.addClass("arrow-left"), l.contentEl = a("div", "".concat(mt, "-dropdown-content")).css("width", n).hide();
        ...
        return function (t, e) {
            ...
            key: "setContentChildren", value: function () {
                var t;
    ...
    var Nn = function (t) {
        function e(t, n) {
            ...
            var o = new Jt("align-".concat(n)), l = t.map(function (t) {
    ...
    var Vr = function (t) {
        function e(t, n) {
            ...
            var i = new Jt(t).css("height", "16px").css("border-bottom", "3px solid ".concat(n)), o = new zr;
    ...
    var $r = [["thin", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" style="user-select: none;"></line></svg>'], ["medium", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="2" style="user-select: none;"><line x1="0" y1="1.0" x2="50" y2="1.0" stroke-width="2" stroke="black" style="user-select: none;"></line></svg>'], ["thick", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="3" style="user-select: none;"><line x1="0" y1="1.5" x2="50" y2="1.5" stroke-width="3" stroke="black" style="user-select: none;"></line></svg>'], ["dashed", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" stroke-dasharray="2" style="user-select: none;"></line></svg>'], ["dotted", '<svg xmlns="http://www.w3.org/2000/svg" width="50" height="1" style="user-select: none;"><line x1="0" y1="0.5" x2="50" y2="0.5" stroke-width="1" stroke="black" stroke-dasharray="1" style="user-select: none;"></line></svg>']],
        Xr = function (t) {
            function e(t) {
                var n, r;
                !function (t, e) {
                ...
                var i = new Jt("line-type"), o = 0, l = $r.map(function (e, n) {
    ...
    var Qr = function t() {
        ...
        }, this.ddColor = new Vr("line-color", this.color), this.ddColor.change = function (t) {
            r.color = t
    ...
    var ii = function (t) {
        function e() {
            ...
            var n = new Jt("border-all"), r = new Qr;
    ...
    var ka = function (t) {
        function e() {
            var t;
            va(this, e);
            var n = new Jt("ellipsis"), r = a("div", "".concat(mt, "-toolbar-more"));
    ...
    function ja() {
        ...
        var s = n.box(), u = 160, f = 12, h = [], p = [];
        o.forEach(function (t, e) {
            var n = xa(t, 2), r = n[0], i = n[1];
    ...
    var Ra = function () {
        function t(e, n) {
            ...
            }, this.el = a("div", "".concat(mt, "-form-input")), this.input = a("input", "").css("width", e).on("input", function (t) {
                return r.vchange(t)
    ...
    var Da = function () {
        function t(e, n, r) {
            ...
            }, this.el = a("div", "".concat(mt, "-form-select")), this.suggest = new Lt(n.map(function (t) {
    ...
    var Ha = {number: /(^\d+$)|(^\d+(\.\d{0,4})?$)/, date: /^\d{4}-\d{1,2}-\d{1,2}$/}, Ma = function () {
        function t(e, n, r, i) {
            var o = this;
            !function (t, e) {
                if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
    ...
    var Ba = 100, La = function (t) {
        function e() {
            ...
            var n = new Ma(new Da("cell", ["cell"], "100%", function (t) {
                ...
                }), {required: !0}, "".concat(L("dataValidation.range"), ":"), Ba),
                ...
                }), {required: !0}, "".concat(L("dataValidation.criteria"), ":"), Ba),
                ...
                }), {required: !0}).hide(), l = new Ma(new Ra("70px", "10"), {required: !0}).hide(),
                c = new Ma(new Ra("70px", "100"), {required: !0, type: "number"}).hide(),
                s = new Ma(new Ra("120px", "a,b,c"), {required: !0}),
                u = new Ma(new Ra("70px", "10"), {required: !0, type: "number"}).hide();
            ...
            }))]))).mf = n, t.rf = r, t.cf = i, t.of = o, t.minvf = l, t.maxvf = c, t.vf = u, t.svf = s, t.change = function () {
            }, t
        }
            ...
            key: "setValue", value: function (t) {
                if (t) {
                    var e = this.mf, n = this.rf, r = this.cf, i = this.of, o = this.svf, a = this.vf, l = this.minvf,
                        c = this.maxvf, s = t.mode, u = t.ref, f = t.validator || {type: "list"}, h = f.type,
                        p = f.operator, d = f.value;
    ...
    function Ja(t, e) {
        var n = a("div", "".concat(mt, "-toast")), r = a("div", "".concat(mt, "-dimmer active"));
        ...
        var i = n.box(), o = i.width, l = i.height, c = document.documentElement, s = c.clientHeight, u = c.clientWidth;
    ...
    function el(t, e) {
        var n = this.selector, r = this.data, i = r.rows, o = r.cols, a = Ga(n.indexes, 2), l = a[0], c = a[1],
            s = n.range, u = s.eri, f = s.eci;
        if (t) {
            var h = Ga(n.moveIndexes, 2);
            l = h[0], c = h[1]
        }
        "left" === e ? c > 0 && (c -= 1) : "right" === e ? (f !== c && (c = f), c < o.len - 1 && (c += 1)) : "up" === e ? l > 0 && (l -= 1) : "down" === e ? (u !== l && (l = u), l < i.len - 1 && (l += 1)) : "row-first" === e ? c = 0 : "row-last" === e ? c = o.len - 1 : "col-first" === e ? l = 0 : "col-last" === e && (l = i.len - 1), t && (n.moveIndexes = [l, c]), tl.call(this, t, l, c), function () {
            var t = this.data, e = this.verticalScrollbar, n = this.horizontalScrollbar, r = t.getSelectedRect(),
                i = r.l, o = r.t, a = r.left, l = r.top, c = r.width, s = r.height, u = this.getTableOffset();
            if (Math.abs(a) + c > u.width) n.move({left: i + c - u.width}); else {
                var f = t.freezeTotalWidth();
                a < f && n.move({left: i - 1 - f})
            }
            if (Math.abs(l) + s > u.height) e.move({top: o + s - u.height - 1}); else {
    ...
    function il() {
        ...
        t.attr(c), e.offset(c), n.offset(l), a.css("width", "".concat(c.width, "px")), nl.call(this), rl.call(this), function () {
            var t = this.selector, e = this.data, n = this.editor, r = Ga(e.freeze, 2), i = r[0], o = r[1];
            if (i > 0 || o > 0) {
    ...
    function cl(t, e) {
        var n = this.data;
        if ("read" !== n.settings.mode) if (n.paste(t, function (t) {
            return Ja("Tip", t)
        })) il.call(this); else if (e) {
    ...
    function ul(t) {
        var e = this, n = this.selector, r = this.data, i = this.table, o = this.sortFilter, a = t.offsetX,
            l = t.offsetY, c = t.target.className === "".concat(mt, "-selector-corner"), s = r.getCellRectByXY(a, l),
            u = s.left, f = s.top, h = s.width, p = s.height, d = s.ri, y = s.ci, v = r.autoFilter;
        if (v.includes(d, y) && u + h - 20 < a && f + p - 20 < l) {
            var b = v.items(y, function (t, e) {
                return r.rows.getCell(t, e)
            });
            return o.set(y, b, v.getFilter(y), v.getSort(y)), void o.setOffset({left: u, top: f + p + 2})
        }
    ...
    function yl(t, e) {
        var n = this.data;
        if ("undo" === t) this.undo(); else if ("redo" === t) this.redo(); else if ("print" === t) this.print.preview(); else if ("paintformat" === t) !0 === e ? al.call(this) : ol.call(this); else if ("clearformat" === t) dl.call(this, "delete-cell-format"); else if ("link" === t) ; else if ("chart" === t) ; else if ("autofilter" === t) (function () {
            this.data.autofilter(), il.call(this)
        }).call(this); else if ("freeze" === t) if (e) {
            var r = n.selector, i = r.ri, o = r.ci;
            this.freeze(i, o)
        } else this.freeze(0, 0); else n.setSelectedCellAttr(t, e), "formula" !== t || n.selector.multiple() || hl.call(this), il.call(this)
    }

    function vl() {
        var t, e, n, r, i, o, a = this, l = this.selector, c = this.overlayerEl, s = this.rowResizer,
            u = this.colResizer, f = this.verticalScrollbar, h = this.horizontalScrollbar, p = this.editor,
            d = this.contextMenu, y = this.toolbar, v = this.modalValidation, b = this.sortFilter;
        c.on("mousemove", function (t) {
            ...
            (function (t) {
                var e = this.verticalScrollbar, n = this.horizontalScrollbar, r = this.data, i = e.scroll().top,
                    o = n.scroll().left, a = r.rows, l = r.cols, c = t.deltaY, s = t.deltaX, u = function (t, e) {
                        var n = t, r = 0;
                        do {
                            r = e(n), n += 1
                        } while (r <= 0);
                    ...
                    }, h = Math.abs(c), p = Math.abs(s), d = Math.max(h, p);
    ...
    var Pl = function () {
        ...
        function t() {
            var e = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : function () {
        ...
        return Sl(t, [{
            key: "addItem", value: function (t, e) {
                ...
                r.on("click", function () {
                    ...
                    var e = t.target, i = e.offsetLeft, o = e.offsetHeight;
                    n.contextMenu.setOffset({left: i, bottom: o + 1}), n.deleteEl = r
                }).on("dblclick", function () {
                    var t = r.html(), e = new Ra("auto", "");
                    e.val(t), e.input.on("blur", function (e) {
                        var r = e.target.value, i = n.dataNames.findIndex(function (e) {
                            return e === t
                        });
                        n.renameItem(i, r)
            ...
            key: "renameItem", value: function (t, e) {
            ...
            key: "deleteItem", value: function () {
                var t = this.activeEl, e = this.deleteEl;
            ...
            key: "clickSwap2", value: function (t) {
            ...
            key: "clickSwap", value: function (t) {
        ...
        return e = t, r = [{
            ...
            key: "addSheet", value: function (t) {
                var e = this, n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
                    r = t || "sheet".concat(this.sheetIndex), i = new ht(r, this.options);
            ...
            key: "deleteSheet", value: function () {
                var t = Rl(this.bottombar.deleteItem(), 2), e = t[0], n = t[1];
                e >= 0 && (this.datas.splice(e, 1), n >= 0 && this.sheet.resetData(this.datas[n]))
            }
        }, {
            key: "loadData", value: function (t) {
                var e = Array.isArray(t) ? t : [t];
                if (this.bottombar.clear(), this.datas = [], e.length > 0) for (var n = 0; n < e.length; n += 1) {
