...
/***/ (function(module, exports, __webpack_require__) {
	...
	var PdfUI = __webpack_require__(2);

	window.createPdfJS = function(){
	    var pdfJS = new PdfJS();
	    pdfJS.setUI(new PdfUI());

	    return pdfJS;
	};

	window.pdfParser = function(file, successFn, errorFn){
	    window.pdfJS.parse(file, successFn, errorFn);
	};

	window.pdfAfterRender = function(element, callBackFn, sheetId) {
	    window.pdfJS.render(element, callBackFn, sheetId);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MobileUI = __webpack_require__(3);
...
/***/ (function(module, exports) {
	...
	function DesktopUI(instance) {
	    ...
	    this.totalPage = this.fileInfo.totalPage;
	...
	DesktopUI.prototype = {
	    ...
	    viewButton: function (action) {
            this.moveButtons(this.$menuBtns.footer.prev, 270, action);
            this.moveButtons(this.$menuBtns.footer.next, 220, action);
