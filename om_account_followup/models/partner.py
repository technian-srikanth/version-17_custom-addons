        ...
        if partner.unreconciled_aml_ids:
            ...
            for currency_dict in final_res:
                ...
                for aml in currency_dict['line']:
                    ...
                    # --- FIXED SECTION START ---
                    # Use Odoo's fields.Date.from_string to handle date conversion safely
                    raw_date = aml['date_maturity'] or aml['date']
                    if isinstance(raw_date, str):
                        try:
                            # Try standard Odoo format first
                            date = fields.Date.from_string(raw_date)
                        except ValueError:
                            # Fallback for the specific format causing the crash
                ...
                if part.payment_responsible_id != \
                    ...
                    part.message_post(
                        body=_("You became responsible to do the next action "
                             ...
                             " </a></b>",
                        message_type='comment',  # ✅ correct
                        subtype_xmlid='mail.mt_comment',  # ✅ recommended
                        partner_ids=[responsible_partner_id]  # ✅ OK
                    )
